...
public class MealsUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(getFilteredWithExceededInOneReturn(MEALS, LocalTime.of(7, 0), LocalTime.of(12, 0), DEFAULT_CALORIES_PER_DAY));
	}
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
	...
	*/
	public static List<MealWithExceed> getFilteredWithExceededInOneReturn(Collection<Meal> meals, LocalTime startTime,
